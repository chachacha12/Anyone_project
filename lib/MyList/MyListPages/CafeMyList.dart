...
///내 찜리스트
class CafeMyList extends StatefulWidget {
  const CafeMyList({Key? key}) : super(key: key);

  @override
  State<CafeMyList> createState() => _CafeMyListState();
}


class _CafeMyListState extends State<CafeMyList> {

  var cafeMyList; //내찜목록 컬렉션
  var count = 0;
                            ...
                            Row( ///가게명과 찜버튼
                              ...
                              children: [
                                Flexible(
                                  fit: FlexFit.tight,
                                  flex: 7,
                                  child:contentsName(  cafeMyList[index]['name']), //CommonWidget파일안에 있는 함수
                                ),
                                  ...
                                  Flexible(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        NaverMapDeepLink(
                                            titlename: cafeMyList[index]['name']),

                                        Text(
                                          cafeMyList[index]['tag'
                                          ],
                                          style: TextStyle(
