...
///내 찜리스트
class PubMyList extends StatefulWidget {
  const PubMyList({Key? key}) : super(key: key);

  @override
  State<PubMyList> createState() => _PubMyListState();
}


class _PubMyListState extends State<PubMyList> {
                            ...
                            Row( ///가게명과 찜버튼
                              ...
                              children: [
                                Flexible(
                                  fit: FlexFit.tight,
                                  flex: 7,
                                  child:contentsName(  pubMyList[index]['name']), //CommonWidget파일안에 있는 함수
                                ),
                                  ...
                                  Flexible(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        NaverMapDeepLink(
                                            titlename: pubMyList[index]['name']),
