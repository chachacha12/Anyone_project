...
import '../../home/aroundcampus_content/groceryshop/GroceryShop_hero_second.dart';
...
///내 찜리스트
class GroceryMyList extends StatefulWidget {
  const GroceryMyList({Key? key}) : super(key: key);

  @override
  State<GroceryMyList> createState() => _GroceryMyListState();
}


class _GroceryMyListState extends State<GroceryMyList> {
  var groceryMyList; //내찜목록 컬렉션
  var count = 0;
                    ...
                    Container( //컨텐츠 하나하나
                        ...
                        child: Column(
                          ...
                          children: [
                            Row( ///가게명과 찜버튼
                              ...
                              children: [
                                Flexible(
                                  fit: FlexFit.tight,
                                  flex: 7,
                                  child:contentsName(  groceryMyList[index]['name']), //CommonWidget파일안에 있는 함수
                                ),
                                  ...
                                  Flexible(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        NaverMapDeepLink(
                                            titlename: groceryMyList[index]['name']),
                            ...
                            getImageList(groceryMyList[index]),
